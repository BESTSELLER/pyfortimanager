...
class FortiSwitches_Proxy(FortiManager):
    ...
    def all(self, fortigate: str, vdom: str="root", switch_id: str=None, adom: str=None, timeout: int=None):
            ...
            "data":
                {
                    ...
                    "action": "get",
                    "resource": f"/api/v2/monitor/switch-controller/managed-switch/status?vdom={vdom}"
                }
        }
